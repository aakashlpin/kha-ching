  ...
  return (
    <Drawer open={isOpen} onClose={() => handleClose(false)} className={classes.drawer}>
      <Box display="flex" alignItems="center" className={classes.nameContainer}>
        ...
        <Typography variant="h6">{user?.session?.user_shortname}</Typography>
      </Box>
      <List className={classes.list}>
        <ListItem button onClick={() => router.push('/profile')}>
          ...
          <ListItemText
            ...
            primaryTypographyProps={{ className: 'primaryLight' }}
          />
          <ListItemSecondaryAction>
            <ChevronRightIcon />
          </ListItemSecondaryAction>
        ...
        {user?.isClubMember ? null : (
          <ListItem button onClick={() => router.push('/plan')}>
            <ListItemIcon>
              <FavoriteBorderIcon />
            </ListItemIcon>
            <ListItemText
              primary="daily trading plan"
              primaryTypographyProps={{ className: 'primaryLight' }}
            />
            <ListItemSecondaryAction>
              <ChevronRightIcon />
        ...
        {user?.isClubMember ? null : (
          <ListItem button onClick={() => router.push('/new-trade')}>
            <ListItemIcon>
              <AddIcon />
            </ListItemIcon>
            <ListItemText
        ...
        <ListItem button onClick={() => alert('coming soon.. stay tuned 🙂')}>
          ...
          <ListItemText
            primary="subscriptions and payments"
            primaryTypographyProps={{ className: 'primaryLight' }}
          />
          <ListItemSecondaryAction>
            <ChevronRightIcon />
