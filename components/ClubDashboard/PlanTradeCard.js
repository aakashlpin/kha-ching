...
export default function PlanTradeCard({ tradesDay, todaysPlans }) {
    ...
    const planInfoToDisplay = [
        { label: "Trading Amount", value: `upto ₹ ${todaysPlanAggregatedMeta.tradingAmount}`, valueColor: "primary" },
    ...
    return (
        <Card>
            ...
            {
                !hasTradeStarted ? <CardActions>
                    <Button variant="contained" color="primary" onClick={() => handleScheduleJob(plan)} fullWidth>
                        schedule trade
                    </Button>
                </CardActions> : null
            }
