  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <Box
          borderRadius="16px"
          bgcolor={TRADE_STATUS_DISPLAY_CONFIG.completed.bgColor}
          p="8px"
          style={{ display: 'flex', flexDirection: 'column' }}>
          <Typography
            gutterBottom
            variant="caption"
            style={{ color: TRADE_STATUS_DISPLAY_CONFIG.completed.titleColor }}>
        ...
        <Box
          borderRadius="16px"
          bgcolor={TRADE_STATUS_DISPLAY_CONFIG.active.bgColor}
          p="8px"
          style={{ display: 'flex', flexDirection: 'column' }}>
          <Typography
            gutterBottom
            variant="caption"
            style={{ color: TRADE_STATUS_DISPLAY_CONFIG.active.titleColor }}>
