...
import { COMBINED_SL_EXIT_STRATEGY_LABEL, EXIT_STRATEGIES, EXIT_STRATEGIES_DETAILS } from '../../lib/constants'
          ...
          <>
            <Grid item xs={12}>
              ...
              <RadioGroup
                ...
                onChange={(e) => onChange({ combinedExitStrategy: e.target.value as COMBINED_SL_EXIT_STRATEGY })}
              >
                {[COMBINED_SL_EXIT_STRATEGY.EXIT_ALL, COMBINED_SL_EXIT_STRATEGY.EXIT_LOSING].map((combinedExitStrategy) => (
                  <FormControlLabel
