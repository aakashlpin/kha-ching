import { INSTRUMENT_DETAILS, BROKER } from '../../constants'
...
async function optionSellerOptionEntry ({ initialJobData, optionStrike }) {
  ...
  //     transaction_type: type === 'BUY' ? kite.kc.TRANSACTION_TYPE_BUY : kite.kc.TRANSACTION_TYPE_SELL,
  //     order_type: kite.kc.ORDER_TYPE_SLM,
  //     product: order.product,
  //     tag: initialJobData.orderTag
  //   }
  //   console.log('placing exit orders...', exitOrder)
  //   return kite.placeOrder(kite.kc.VARIETY_REGULAR, exitOrder)
  // })
