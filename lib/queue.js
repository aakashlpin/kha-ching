...
export const ancillaryQueueScheduler = new QueueScheduler(ANCILLARY_Q_NAME, queueOptions)
export const ancillaryQueue = new Queue(ANCILLARY_Q_NAME, queueOptions)

const allQueues = [
  tradingQueueScheduler, tradingQueue,
  exitTradesQueueScheduler, exitTradesQueue,
  autoSquareOffQueueScheduler, autoSquareOffQueue,
  watcherQueueScheduler, watcherQueue,
  ancillaryQueueScheduler, ancillaryQueue
]
