...
export default async (args) => {
  ...
  if (!accessToken) {
    return Promise.reject('[Kiteconnect] not authorized or access revoked');
  }

  if (lots % 3 !== 0) {
    return Promise.reject('Error: lots should be in multiple of 3 for this strategy');
  }
  ...
  if (
    ...
    return Promise.reject('Not enough margin');
  }
