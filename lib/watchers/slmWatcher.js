...
import { getInstrumentPrice, syncGetKiteInstance } from '../utils';
...
const slmWatcher = async ({ slmOrderId, user, originalTriggerPrice, __queueJobData }) => {
  ...
  try {
    ...
    const ltp = await getInstrumentPrice(kite, tradingsymbol, exchange);
    ...
    /**
     * TODO: handle this - any failed API call above can terminate the checker
     *
     *  [kha-ching] [2021-07-20 09:42:20] 🔴 [slmWatcher] error. Checker terminated!! {
        [kha-ching] [2021-07-20 09:42:20]   message: 'No response from server with error code: ECONNABORTED',
        [kha-ching] [2021-07-20 09:42:20]   error_type: 'NetworkException',
        [kha-ching] [2021-07-20 09:42:20]   data: null
        [kha-ching] [2021-07-20 09:42:20] }
     */
